...
//    GRANDE
    private static final int[][] NIVEL = {
            ...
            {BASESUP, BASEAR_, BASEAR_, BASESUP, BOMBA__, BASESUP, BASESUP, BASESUP, BASESUP},
            ...
            {BASESUP, BASESUP, BASEAR_, BASESUP, BASESUP, BASESUP, BASESUP, BASESUP, PEDRA__},
    ...
    public List<BaseSuportadora> getBasesSuporteAdjacentes(Posicao posicao) {
        List<BaseSuportadora> bases = new ArrayList<>();
    ...
    public List<BaseSuportadora> getBasesSuporteProximas(Posicao posicao) {
        List<BaseSuportadora> bases = new ArrayList<>();

        bases.addAll(getBasesSuporteAdjacentes(posicao));
